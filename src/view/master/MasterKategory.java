...
import dao.DAOKategory;
import tabelmodel.TableModKategory;
 ...
 * @author fuadm
 */
public class MasterKategory extends javax.swing.JPanel {

    private ServiceKategory servis = new DAOKategory();
    private TableModKategory tblModel = new TableModKategory();

    public MasterKategory() {
        initComponents();
        tblKategory.setModel(tblModel);
    ...
    private void initComponents() {
        ...
        tblKategory = new custom.TableCustom();
        ...
        jLabel1.setText("Data Kategoris");
    ...
    private custom.TableCustom tblKategory;
    // End of variables declaration//GEN-END:variables

    private void loadData() {
        deleteBtn.setVisible(false);
        CancelBtn.setVisible(false);
        List<ModelKategory> list = servis.getData();
        tblModel.setData(list);
    }

    private void simpanData() {
        if (validasiInput() == true) {
            String namaKetegoriS = inputnama.getText();

            ModelKategory moka = new ModelKategory();

            moka.setNamakategori(namaKetegoriS);
            servis.addData(moka);
            tblModel.addData(moka);
            loadData();
            resetForm();
            tampilPanel();
    ...
    private void perbaruhiData() {
        int index = tblKategory.getSelectedRow();
        if (index != -1) {
            ModelKategory moka = tblModel.getData(tblKategory.convertRowIndexToModel(index));
    ...
    private void tampilPanel() {
        MainPanel.removeAll();
        MainPanel.add(new MasterKategory());
        MainPanel.repaint();
        MainPanel.revalidate();
    }
    ...
    private void dataTabel() {
        ...
        int row = tblKategory.getSelectedRow();
        jLabel2.setText("Perbaruhi Data Kategori");

        inputId.setText(tblKategory.getModel().getValueAt(row, 1).toString());
        inputnama.setText(tblKategory.getModel().getValueAt(row, 2).toString());
        aktif();
    ...
    private void hapusData() {
        ...
        int modelRow = tblKategory.convertRowIndexToModel(index);

        ModelKategory moka = tblModel.getData(modelRow);
